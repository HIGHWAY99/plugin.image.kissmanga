...
def ps(x):
	return {
		'__plugin__': 					"KissManga"
		,'__authors__': 				"[COLOR white]The[COLOR tan]Highway[/COLOR][/COLOR]"
		,'__credits__': 				""
		,'_addon_id': 					"plugin.image.kissmanga"
		,'_plugin_id': 					"plugin.image.kissmanga"
		,'_domain_url': 				"http://kissmanga.com"
		,'_database_name': 			"kissmanga"
		,'common_word': 				"Manga"
		,'common_word2': 				"Read"
		,'_addon_path_art': 		"art"
		...
		,'img_next':						'http://kissmanga.com/Content/images/next.png'
		,'img_prev':						'http://kissmanga.com/Content/images/previous.png'
		,'img_az':							'http://kissmanga.com/Content/images/logo.png'
		,'img_search':					'http://kissmanga.com/Content/images/read.png'
		,'img_hot':							'http://kissmanga.com/Content/images/hot.png'
		,'img_updated':					'http://kissmanga.com/Content/images/newupdate.png'
		,'GENRES': 							['Action','Adult','Adventure','Comedy','Doujinshi','Drama','Ecchi','Fantasy','Gender Bender','Harem','Historical','Horror','Josei','Lolicon','Manga','Manhua','Manhwa','Martial Arts','Mature','Mecha','Mystery','One shot','Psychological','Romance','School Life','Sci-fi','Seinen','Shotacon','Shoujo','Shoujo Ai','Shounen','Shounen Ai','Slice of Life','Smut','Sports','Supernatural','Tragedy','Yaoi','Yuri']
